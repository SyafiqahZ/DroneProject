...
class Tello_Pose:
    def __init__(self):
        ...
        self.arms_up_45_cnt = 0       # count numbers of the arm_V captured in every certain number of frames
    ...
    def detect(self, frame):
        ...
        if self.frame_cnt == frame_cnt_threshold:
            ...
            if self.arm_flat_cnt >= pose_captured_threshold:
                cmd = 'snapshot'
            if self.arms_up_45_cnt == self.frame_cnt :
                cmd = 'takeOff'
            self.frame_cnt = 0
            self.arm_down_45_cnt = 0
            self.arm_flat_cnt = 0
            self.arms_up_45_cnt = 0
